    ...
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
        ...
        <Template>
            ...
            <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr"
                ...
                <GridProperties FastFilterFields="ARPayment__ExtRefNbr, CustomerID, CustomerID_Customer_acctName" ></GridProperties>
            </px:PXSelector>
            <px:PXDropDown ID="edStatus" runat="server" DataField="Status" Enabled="False" ></px:PXDropDown>
            <px:PXCheckBox Size="s" CommitChanges="True" ID="chkHold" runat="server" DataField="Hold" ></px:PXCheckBox>
            ...
            <px:PXSelector CommitChanges="True" ID="edAdjFinPeriodID" runat="server"
                DataField="AdjFinPeriodID" DataSourceID="ds" AutoRefresh="True"></px:PXSelector>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerID" runat="server"
                DataField="CustomerID" AllowAddNew="True" AllowEdit="True" DataSourceID="ds" ></px:PXSegmentMask>
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerLocationID" runat="server"
                AutoRefresh="True" DataField="CustomerLocationID" DataSourceID="ds" ></px:PXSegmentMask>
            ...
            <px:PXSelector CommitChanges="True" ID="edPMInstanceID" runat="server"
                ...
                AutoGenerateColumns="True" DataSourceID="ds" ></px:PXSelector>
            ...
            <px:PXTextEdit ID="edCCPaymentStateDescr" runat="server" DataField="CCPaymentStateDescr" Enabled="False" ></px:PXTextEdit>
			<px:PXSegmentMask CommitChanges="True" ID="edCashAccountID" runat="server"
                DataField="CashAccountID" AutoRefresh="True" DataSourceID="ds" ></px:PXSegmentMask>
            ...
            <px:PXDateTimeEdit ID="edDepositAfter" runat="server" DataField="DepositAfter" CommitChanges="True" ></px:PXDateTimeEdit>
            ...
            <px:PXNumberEdit ID="edCuryOrigDocAmt" runat="server" DataField="CuryOrigDocAmt" CommitChanges="True"></px:PXNumberEdit>
            ...
            <px:PXNumberEdit ID="edCurySOApplAmt" runat="server" DataField="CurySOApplAmt" Enabled="False" ></px:PXNumberEdit>
            ...
            <px:PXNumberEdit ID="edCuryWOAmt" runat="server" DataField="CuryWOAmt" Enabled="False" ></px:PXNumberEdit>
            <px:PXNumberEdit ID="edCuryChargeAmt" runat="server" DataField="CuryChargeAmt" Enabled="False" ></px:PXNumberEdit>
            <px:PXNumberEdit ID="edCuryConsolidateChargeTotal" runat="server" DataField="CuryConsolidateChargeTotal" Enabled="False" ></px:PXNumberEdit>
            <px:PXCheckBox SuppressLabel="True" ID="chkIsCCPayment" runat="server" DataField="IsCCPayment" ></px:PXCheckBox>
