		...
		<px:PXGrid ID="relatedItemsGrid" runat="server" DataSourceID="ds" Height="150px" Width="100%" ActionsPosition="Top" SkinID="Details" 
			...
			<Levels>
				<px:PXGridLevel DataMember="RelatedItems" DataKeyNames="InventoryID,Relation" ImportDataMember="RelatedItems">
					<Columns>
						<px:PXGridColumn DataField="Relation" Width="100px" CommitChanges="true" Type="DropDownList" ></px:PXGridColumn>
						<px:PXGridColumn DataField="Rank" Width="60px" CommitChanges="true"></px:PXGridColumn>
						<px:PXGridColumn DataField="Tag" Width="180px" CommitChanges="true" Type="DropDownList" ></px:PXGridColumn>
						<px:PXGridColumn DataField="RelatedInventoryID" Width="150px" CommitChanges="true" LinkCommand="ViewRelatedItem" ></px:PXGridColumn>
						<px:PXGridColumn DataField="Desc" Width="250px" ></px:PXGridColumn>
						<px:PXGridColumn DataField="UOM" Width="90px" DisplayFormat="&gt;aaaaaa" CommitChanges="true" ></px:PXGridColumn>
						<px:PXGridColumn DataField="EffectiveDate" Width="100px" CommitChanges="true" ></px:PXGridColumn>
						<px:PXGridColumn DataField="ExpirationDate" Width="100px" CommitChanges="true" ></px:PXGridColumn>
						<px:PXGridColumn DataField="IsActive" Width="60px" Type="CheckBox" CommitChanges="true" ></px:PXGridColumn>
					</Columns>
					<RowTemplate>
						<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" ></px:PXLayoutRule>
				...
				<Levels>
					<px:PXGridLevel DataMember="CompatibleDevices">
						<Columns>
							...
							<px:PXGridColumn DataField="RSSVDevice__Description" Width="280" /></Columns>
						<RowTemplate>
							<px:PXSelector runat="server" ID="CstPXSelector4" DataField="DeviceID" AllowEdit="True" /></RowTemplate></px:PXGridLevel></Levels>
				<AutoSize Enabled="True" MinHeight="200" />
				<Mode AllowAddNew="True" AllowDelete="True" AllowUpdate="True" /></px:PXGrid></Template></px:PXTabItem></Items>
        <AutoSize Enabled="True" MinHeight="150" ></AutoSize>
    </px:PXTab>
